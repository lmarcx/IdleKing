...
export const STORY_LEVELS: StoryLevelDef[] = [
  ...
  },
  {
    ...
    kind: "standard",
    title: "Sang Alien",
    description: "Des signes etranges laissent penser que la tundra cache une presence non humaine.",
    recommendedPower: 70,
    isRequiredForNarrative: true,
  ...
  },
  {
    ...
    index: 1,
    kind: "standard",
    title: "Chute dans le Temps des Dieux",
    description: "La route bascule vers un age ou les lois du monde semblent differentes.",
