// DEFERRED balancing placeholders. Runtime rules are locked, these values are tunable.
export const SPRINT_STAMINA_COST_PER_SECOND = 12;
export const DASH_STAMINA_COST = 20;
export const DASH_COOLDOWN_SECONDS = 0.75;
