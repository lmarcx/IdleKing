...
export function DuelArenaView({ opponent }: DuelArenaViewProps) {
  return (
    <section className="relative h-[calc(100vh-2rem)] min-h-[44rem] overflow-hidden rounded-xl border border-amber-200/25 bg-black shadow-[0_22px_70px_rgba(0,0,0,0.48)]">
      ...
      <div className="pointer-events-none absolute left-4 top-4 z-10 max-w-sm rounded-lg border border-amber-200/20 bg-black/65 px-4 py-3 shadow-[0_12px_30px_rgba(0,0,0,0.38)]">
      ...
      <Link
        className="pointer-events-auto absolute right-4 top-4 z-10 rounded-md border border-amber-200/35 bg-black/65 px-4 py-2 font-ik-menu text-xs text-amber-50 transition hover:border-amber-100 hover:bg-amber-500/16"
