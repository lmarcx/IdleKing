...
export function WorldModeNode({ className, href, icon, label, status }: WorldModeNodeProps) {
  const content = (
    <>
      ...
      <span className="grid h-16 w-16 place-items-center rounded-full border border-border/60 bg-black/30 shadow-[0_0_18px_rgba(242,242,242,0.08)] transition-transform group-hover:scale-105">
