...
export default function FarmPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="ik-title text-2xl font-semibold">Farm Allocation</h1>
      <p className="ik-informative text-sm text-muted-foreground">Set villagers per resource and apply normalized allocation.</p>
