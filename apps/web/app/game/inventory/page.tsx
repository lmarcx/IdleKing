...
export default function InventoryPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="ik-title text-2xl font-semibold">Inventory</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent>
            {state.inventory.items.length === 0 ? (
              <p className="ik-informative text-sm text-muted-foreground">No equipment crafted yet.</p>
            ) : (
        ...
        <Card>
          ...
          <CardContent>
            {resources.length === 0 ? (
              <p className="ik-informative text-sm text-muted-foreground">No resources in stock.</p>
            ) : (
